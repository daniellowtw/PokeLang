...
effect1: EFFECTIVE 
	...
	| NO_EFFECT
		{$$ =['NO_EFFECT']}
	;
LASH|ACIDARMOR|CRABHAMMER|EXPLOSION|FURYSWIPES|BONEMERANG|REST|ROCKSLIDE|HYPERFANG|SHARPEN|CONVERSION|TRIATTACK|SUPERFANG|SLASH|SUBSTITUTE|STRUGGLE)                     return 'MOVE'
([A-Z]+) 		return 'OPPONENT'
.                     return 'INVALID'
