...
var initOperations = function() {
  ...
  createOperation('out', ['NUM'], function(num1) {
    ...
    interpreter.out.apply(null, String.fromCharCode(num1.value));
...
var setOutputFunction = function(out) {

  interpreter.out = out || (function(value) {
...
var createObjConstructor = function(subclass) {

  interpreter[subclass + 'Obj'] = function(value) {

    this.value = value;

  }

  interpreter[subclass + 'Obj'].prototype = new Obj();
  interpreter[subclass + 'Obj'].prototype.constructor = interpreter[subclass + 'Obj'];

  interpreter[subclass.toLowerCase()] = function(value) {

    return new interpreter[subclass + 'Obj'](value);
...
createObjConstructor('Array');
createObjConstructor('Mark');
createObjConstructor('Block');

var num = interpreter.num;
var array = interpreter.array;
var mark = interpreter.mark;
var block = interpreter.block;
