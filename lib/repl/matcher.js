...
var compareWord = function(actual, expected) {
  ...
  if (expected[0] === '$') {
    ...
    result =  errors.unexpectedToken(expected, actual, reader.current_line);
...
var createMatchCases = function() {
  ...
  createMatchCase('$POKEMON', function(actual) {
    ...
    if (!pokedex.pokemon[actual]) {
      ...
      return errors.unrecognisedPokemon(actual, reader.current_line);
  ...
  createMatchCase('$POKEMON!', function(actual) {
    ...
    if (exclamation !== '!') {
      ...
      if (result === true) {
        ...
        return errors.missingPunctuation('!', reader.current_line); 
  ...
  createMatchCase('$TRAINER', function(actual) {
    ...
    if (!actual.match(/[A-Z]+/)) {
      ...
      return errors.invalidTrainerName(actual, '[A-Z]+', reader.current_line);
  ...
  createMatchCase('$MOVE', function(actual) {
    ...
    if (!pokedex.moveList[actual]) {
      ...
      throw errors.unrecognisedMove(actual, reader.current_line);
