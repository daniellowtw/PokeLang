...
var doMoves = function(first, second) {
  ...
  doSelfMove(first_move);

  doEnemyMove(second_move);
...
var doSelfMove = function(move) {

  print(state.self_pokemon + ' uses  ' + move + '!\n');

  checkEffectiveness(move, state.enemy_pokemon);

};

var doEnemyMove = function(move) {

  print('Foe ' + state.enemy_pokemon + ' uses  ' + move + '!\n');
