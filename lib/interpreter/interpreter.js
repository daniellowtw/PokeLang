...
var performOp = function(op) {
  ...
  operations[op.value + 1].apply(null);


  } catch (err) {

    if (err instanceof TypeError && err.message === 'Cannot call method \'apply\' of undefined') {

      throw errors.unrecognisedOperation(op, battle.getCurrentLine());
